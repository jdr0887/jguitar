...
public class HeptatonicScalesPersistFifthPositionRunnable extends AbstractHeptatonicPersistRunnable {

    private static final Logger logger = LoggerFactory.getLogger(HeptatonicScalesPersistFifthPositionRunnable.class);
    ...
    public HeptatonicScalesPersistFifthPositionRunnable() {
        super();
    }
