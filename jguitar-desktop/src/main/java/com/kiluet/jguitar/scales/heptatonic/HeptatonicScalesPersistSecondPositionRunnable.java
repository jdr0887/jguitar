...
public class HeptatonicScalesPersistSecondPositionRunnable extends AbstractHeptatonicPersistRunnable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(HeptatonicScalesPersistSecondPositionRunnable.class);
    ...
    public HeptatonicScalesPersistSecondPositionRunnable() {
        super();
    }
