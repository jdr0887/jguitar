...
public class HeptatonicScalesPersistThirdPositionRunnable extends AbstractHeptatonicPersistRunnable {

    private static final Logger logger = LoggerFactory.getLogger(HeptatonicScalesPersistThirdPositionRunnable.class);
    ...
    public HeptatonicScalesPersistThirdPositionRunnable() {
        super();
    }
