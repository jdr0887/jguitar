...
public class PentatonicScalesPersistThirdPositionRunnable extends AbstractPentatonicPersistRunnable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PentatonicScalesPersistThirdPositionRunnable.class);
    ...
    public PentatonicScalesPersistThirdPositionRunnable() {
        super();
    }
