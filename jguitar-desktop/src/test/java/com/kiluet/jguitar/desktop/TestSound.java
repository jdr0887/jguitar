...
public class TestSound {
   ...
   public void testSequence() {
      try {
         ...
         midiTrack.add(new MidiEvent(new ShortMessage(ShortMessage.PROGRAM_CHANGE, 0, 27, 0), 0));
         midiTrack.add(new MidiEvent(new ShortMessage(ShortMessage.NOTE_ON, 0, 60, 100), 1));
         midiTrack.add(new MidiEvent(new ShortMessage(ShortMessage.NOTE_OFF, 0, 60, 100), 1 + 32));
